...
class Themes {
  ...
  static final light = ThemeData.light().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(
      background: CustomColor.primaryBGLightColor, // Set your desired background color here
    ),
  ...
  static final dark = ThemeData.dark().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(
      background: CustomColor.primaryBGDarkColor, // Set your desired background color here
    ),
